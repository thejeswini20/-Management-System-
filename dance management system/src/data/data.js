...
export const instructors = [
  { id: 1, name: "Ms. Kavya Reddy", specialization: "Ballet & Contemporary", experience: "8 yrs", students: 24, rating: 4.9, status: "Active", avatar: "#7c3aed", image: "https://images.unsplash.com/photo-1554743395-0e89eaf6b9e5?w=400&q=80" },
  { id: 2, name: "Mr. Arjun Singh", specialization: "Hip-Hop & Street Dance", experience: "6 yrs", students: 31, rating: 4.8, status: "Active", avatar: "#0d9488", image: "https://images.unsplash.com/photo-1547153760-18fc86324498?w=400&q=80" },
  { id: 3, name: "Ms. Sunita Rao", specialization: "Kathak & Bharatanatyam", experience: "12 yrs", students: 18, rating: 5.0, status: "Active", avatar: "#f472b6", image: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&q=80" },
  { id: 4, name: "Ms. Elena Cruz", specialization: "Salsa & Latin", experience: "7 yrs", students: 22, rating: 4.7, status: "Active", avatar: "#f59e0b", image: "https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?w=400&q=80" },
  { id: 5, name: "Mr. Dev Malhotra", specialization: "Contemporary & Jazz", experience: "5 yrs", students: 19, rating: 4.6, status: "On Leave", avatar: "#6366f1", image: "https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=400&q=80" },
];

export const courses = [
  { id: 1, name: "Ballet", level: "Beginner–Advanced", duration: "60 min", fee: 3500, students: 24, instructor: "Ms. Kavya Reddy", image: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=600&q=80", color: "#ede9fe", accent: "#7c3aed", desc: "Classical ballet technique focusing on grace, posture, and fluid movement." },
  ...
  { id: 3, name: "Kathak", level: "All Levels", duration: "75 min", fee: 3200, students: 18, instructor: "Ms. Sunita Rao", image: "https://images.unsplash.com/photo-1545959570-a94084071b5d?w=600&q=80", color: "#fef3c7", accent: "#f59e0b", desc: "North Indian classical dance emphasizing storytelling through expressions and footwork." },
  ...
  { id: 5, name: "Salsa", level: "Beginner–Advanced", duration: "55 min", fee: 3100, students: 19, instructor: "Ms. Elena Cruz", image: "https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?w=600&q=80", color: "#fee2e2", accent: "#ef4444", desc: "Latin partner dance with vibrant music, rhythm, and energetic footwork." },
  { id: 6, name: "Bharatanatyam", level: "All Levels", duration: "90 min", fee: 3300, students: 16, instructor: "Ms. Sunita Rao", image: "https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=600&q=80", color: "#e0e7ff", accent: "#6366f1", desc: "South Indian classical dance form with intricate mudras and nritta patterns." },
];
...
export const testimonials = [
  { name: "Mrs. Sharma", role: "Parent of Aria", text: "Rhythmique transformed my daughter's confidence. The instructors are world-class and truly passionate.", avatar: "#7c3aed", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80" },
  ...
  { name: "Mr. Iyer", role: "Parent of Meera", text: "Best classical dance academy in the city. Meera has won three competitions since joining!", avatar: "#0d9488", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
];
